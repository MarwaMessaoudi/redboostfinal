...
export class KpiCardsComponent {
    kpis = [
        { title: 'Respect de DDL des Tâches', value: '85%', icon: 'pi pi-calendar', description: 'Tâches terminées à temps', progress: 85 },
        { title: 'Avancement Global', value: '72%', icon: 'pi pi-chart-line', description: 'Tâches terminées', progress: 72 },
        { title: 'Temps Moyen par Tâche', value: '3.2h', icon: 'pi pi-clock', description: 'Temps moyen pour la réalisation des tâches', progress: 64 },
        { title: 'Respect des Objectifs', value: '90%', icon: 'pi pi-check-circle', description: 'Objectifs de vente atteints', progress: 90 },
        { title: 'Levée de Fonds', value: '$1.5k', icon: 'pi pi-money-bill', description: 'Fonds levés ce trimestre', progress: 75 },
        { title: 'Taux de Croissance', value: '15%', icon: 'pi pi-chart-bar', description: 'Croissance des startups', progress: 15 }
    ];
