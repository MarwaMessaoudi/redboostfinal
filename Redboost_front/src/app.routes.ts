...
import { CoachDashboardComponent } from './app/pages/coachdashboard/coach-dashboard.component';
import { InvestorDashboardComponent } from './app/pages/inverstdashboard/investor-dashboard';
...
export const appRoutes: Routes = [
  ...
  { path: 'confirm-email', component: ConfirmEmailComponent },
  {
    ...
    children: [
      ...
      {
        path: 'sub-folder/:folderName/:folderMetadataId/:categoryName/:subFolderName',
        component: SubFolderComponent,
      },
      {
        path: 'gestion-folder/folder-details/user-library/:folderName/:folderMetadataId',
      ...
      {
        path: 'marketplace/v1',
        loadChildren: () => import('./app/pages/marketplace/marketplace.routes'),
      },
      {
        path: 'investor/v1',
        loadChildren: () =>
          import('./app/pages/startup/investorStartups/investor.routes'),
      },
      {
        path: 'startup/v1',
        loadChildren: () =>
          import('./app/pages/startup/StartupsRequest/startup.routes'),
      },
      {
        path: 'startup/:id',
        loadChildren: () =>
          import('./app/pages/marketplace/StartupDetails/startup.routes'),
      },
      {
        path: 'startup-details/:id',
        loadChildren: () =>
          import('./app/pages/startup/DetailsInvestment/details.routes'),
      },
      {
        path: 'appointments',
        loadChildren: () =>
          import('./app/pages/appointments/appointments.module').then(
