        ...
        <section class="service-section" #serviceSection>
            <div class="service-content">
                ...
                <div class="service-text">
                    <i class="pi pi-palette icon text-primary" [@textAnimation]="isVisible ? 'visible' : 'hidden'"></i>
                    <h2 class="service-title" [@textAnimation]="isVisible ? 'visible' : 'hidden'">Design & Communication – Boostez votre identité digitale</h2>
                    <p class="service-description" [@textAnimation]="isVisible ? 'visible' : 'hidden'">
                        Une image percutante et une communication efficace sont essentielles pour séduire investisseurs et clients.
                    </p>
