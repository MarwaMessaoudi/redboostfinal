...
import { CoachDashboardService, Kpi, Startup } from '../../frontoffice/service/coachdashboard.service';
import { LoadingSpinnerComponent } from '../../../shared/loading-spinner.component';

@Component({
    selector: 'app-coach-dashboard',
    standalone: true,
    imports: [CommonModule, HttpClientModule, KpiCardsComponent, StartupsTableComponent, LoadingSpinnerComponent],
    template: `
