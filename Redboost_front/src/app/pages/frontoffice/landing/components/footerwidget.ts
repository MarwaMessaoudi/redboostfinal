...
@Component({
    ...
    template: `
        ...
        <div class="banner flex justify-between items-center bg-gradient-to-r from-[#034A55] via-[#6A2C3D] to-[#C8223A] shadow-lg text-white px-8 py-3 md:px-20 lg:px-32 h-[50px] z-50">
            ...
            <button class="border-2 border-e6edee text-034a55 font-semibold px-6 py-1 rounded-lg bg-opacity-0 hover:bg-white hover:text-black hover:scale-110 hover:shadow-xl transition duration-300 ease-in-out transform-gpu">Book a Demo</button>
        </div>
        ...
        <div class="footer-container bg-[#0A4955] text-white py-12 px-6 lg:px-20 overflow-visible">
            <div class="grid grid-cols-12 gap-8">
                <div class="col-span-12 md:col-span-4">
                    <a (click)="router.navigate(['/landing'], { fragment: 'home' })" class="flex items-center cursor-pointer mb-6">
                        <img src="assets/images/logo_redboost.png" alt="Logo" class="h-12 mr-2" />
                    </a>
                    <p class="text-lg text-gray-300">Your All-in-One Platform for Efficient Program Management, Startup Support, and Seamless Communication.</p>
                </div>
                ...
                <div class="col-span-12 md:col-span-3">
                    ...
                    <ul class="list-none p-0">
                        <li class="mb-3">
                            <a href="tel:+216 71 793 125" class="text-lg text-gray-300 hover:text-[#DB1E37] transition-colors duration-300"> <i class="pi pi-phone mr-2"></i>+216 71 793 125 </a>
                        </li>
                        <li class="mb-3">
                            <a href="contactredstart.tn" class="text-lg text-gray-300 hover:text-[#DB1E37] transition-colors duration-300"> <i class="pi pi-envelope mr-2"></i>contactredstart.tn </a>
                        </li>
                        <li>
                ...
                <div class="col-span-12 md:col-span-3">
                    ...
                    <p class="text-lg text-gray-300 mb-4">Stay updated with the latest news and updates from RedBoost.</p>
                    <div class="flex items-center">
                        ...
                        <button class="bg-[#DB1E37] text-white p-2 rounded-r-lg hover:bg-[#0A4955] transition-colors duration-300">Subscribe</button>
                    </div>
                </div>
            </div>
