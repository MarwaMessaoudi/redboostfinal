...
import { StartupDashboardService } from '../../../service/entrepdashboard.service';
import { StartupKpi } from '../../../service/entrepdashboard.service';
  ...
  template: `
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 p-8 bg-gray-50">
      <div *ngFor="let kpi of kpis; let i = index" 
           class="card p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 ease-in-out transform hover:scale-105" 
           [@fadeIn]="getAnimationState(i)">
        <div class="flex flex-col items-center text-center h-full">
          ...
          <div class="relative w-24 h-24 mb-6">
            <svg class="absolute top-0 left-0 w-full h-full" viewBox="0 0 36 36" [@rotate]="getAnimationState(i)">
              ...
              <path class="text-[#DB1E37]" stroke="currentColor" stroke-width="2" stroke-dasharray="100, 100" 
                    [attr.stroke-dashoffset]="animatedOffsets[i]" fill="none" 
